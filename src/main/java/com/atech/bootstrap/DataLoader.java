...
public class DataLoader implements ApplicationListener<ContextRefreshedEvent> {
    ...
    public void onApplicationEvent(ContextRefreshedEvent event) {
        ...
        if (categoryRepository.count() == 0 || measureUnitRepository.count() == 0 ) {
            loadCategories();
            loadUom();
    ...
    private void loadUom(){
        MeasureUnit uom1 = new MeasureUnit();
        uom1.setUnitOfMeasure("Teaspoon");
        measureUnitRepository.save(uom1);

        MeasureUnit uom2 = new MeasureUnit();
        uom2.setUnitOfMeasure("Tablespoon");
        measureUnitRepository.save(uom2);

        MeasureUnit uom3 = new MeasureUnit();
        uom3.setUnitOfMeasure("Cup");
        measureUnitRepository.save(uom3);

        MeasureUnit uom4 = new MeasureUnit();
        uom4.setUnitOfMeasure("Pinch");
        measureUnitRepository.save(uom4);

        MeasureUnit uom5 = new MeasureUnit();
        uom5.setUnitOfMeasure("Ounce");
        measureUnitRepository.save(uom5);

        MeasureUnit uom6 = new MeasureUnit();
        uom6.setUnitOfMeasure("Each");
        measureUnitRepository.save(uom6);

        MeasureUnit uom7 = new MeasureUnit();
        uom7.setUnitOfMeasure("Pint");
        measureUnitRepository.save(uom7);

        MeasureUnit uom8 = new MeasureUnit();
        uom8.setUnitOfMeasure("Dash");
        measureUnitRepository.save(uom8);
    }
    ...
    private List<Recipe> getRecipes() {
        ...
        //get UOMs
        Optional<MeasureUnit> eachUomOptional = measureUnitRepository.findByUnitOfMeasure("Each");

        if(!eachUomOptional.isPresent()){
            throw new RuntimeException("Expected UOM Not Found");
        }

        Optional<MeasureUnit> tableSpoonUomOptional = measureUnitRepository.findByUnitOfMeasure("Tablespoon");

        if(!tableSpoonUomOptional.isPresent()){
            throw new RuntimeException("Expected UOM Not Found");
        }

        Optional<MeasureUnit> teaSpoonUomOptional = measureUnitRepository.findByUnitOfMeasure("Teaspoon");

        if(!teaSpoonUomOptional.isPresent()){
            throw new RuntimeException("Expected UOM Not Found");
        }

        Optional<MeasureUnit> dashUomOptional = measureUnitRepository.findByUnitOfMeasure("Dash");

        if(!dashUomOptional.isPresent()){
            throw new RuntimeException("Expected UOM Not Found");
        }

        Optional<MeasureUnit> pintUomOptional = measureUnitRepository.findByUnitOfMeasure("Pint");

        if(!pintUomOptional.isPresent()){
            throw new RuntimeException("Expected UOM Not Found");
        }

        Optional<MeasureUnit> cupsUomOptional = measureUnitRepository.findByUnitOfMeasure("Cup");
        ...
        //get optionals
        MeasureUnit eachUom = eachUomOptional.get();
        MeasureUnit tableSpoonUom = tableSpoonUomOptional.get();
        MeasureUnit teapoonUom = tableSpoonUomOptional.get();
        MeasureUnit dashUom = dashUomOptional.get();
        MeasureUnit pintUom = dashUomOptional.get();
        MeasureUnit cupsUom = cupsUomOptional.get();
